...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Kinetics locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Kinetics можно использовать локально на этом устройстве.',
  ...
  'to install Kinetics as a full-screen app.': 'чтобы установить Kinetics как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if Kinetics is closed.': 'Оповещения таймера отдыха, даже если Kinetics закрыт.',
  ...
  'A small file a friend imports into their own Kinetics — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Kinetics — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload Kinetics': 'Перезагрузить Kinetics',
