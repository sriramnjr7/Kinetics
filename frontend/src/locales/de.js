...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Kinetics locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst Kinetics trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install Kinetics as a full-screen app.': 'um Kinetics als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if Kinetics is closed.': 'Pausen-Timer-Alarm, auch wenn Kinetics geschlossen ist.',
  ...
  'A small file a friend imports into their own Kinetics — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes Kinetics importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an Kinetics plan file': 'das ist keine Kinetics-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with Kinetics': 'Erstellt mit Kinetics',
  ...
  'Reload Kinetics': 'Kinetics neu laden',
