...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Kinetics locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Kinetics localmente en este dispositivo.',
  ...
  'to install Kinetics as a full-screen app.': 'para instalar Kinetics como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if Kinetics is closed.': 'Avisos del temporizador de descanso, incluso con Kinetics cerrado.',
  ...
  'A small file a friend imports into their own Kinetics — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Kinetics: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload Kinetics': 'Recargar Kinetics',
