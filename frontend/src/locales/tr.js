...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Kinetics locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Kinetics’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install Kinetics as a full-screen app.': 'ile Kinetics’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if Kinetics is closed.': 'Kinetics kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Kinetics — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Kinetics\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
